...
must_haves:
  truths:
    - "Each account row shows account age (e.g., '2y 3m' or '45d')"
    - "Account age is calculated from Reddit created_utc timestamp"
    - "Karma delta shows change from previous check (e.g., '+15' or '-3')"
    - "First-time accounts show '0' for karma delta (no prior data)"
  artifacts:
